...
2. Copy <tt>config/lines_config.yml.example</tt> to <tt>config/lines_config.yml</tt> and adjust the settings as needed. The file is documented, so it should be obvious what you have to adjust.
