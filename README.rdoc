...
Admin viewer SCSS: <tt>assets/stylesheets/admin.css.scss</tt>

Default viewer SCSS: <tt>assets/stylesheets/style.css.scss</tt>
...
To change the header/footer elements you need to open <tt>views/layouts/application.html.erb</tt>
